...
static char re_pat[NPAT];		/* Regex pattern		*/
...
int cond;
{
    ...
    clp = curwp->w_dotp;
    if (curwp->w_doto == llength(clp))	/* Consider dot on next line */
	clp = lforw(clp);
