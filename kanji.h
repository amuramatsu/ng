/* $Id: kanji.h,v 1.3 2001/11/23 11:56:38 amura Exp $ */
/*
 *		Kanji handling inline routines
 *		These are only used when KANJI is #defined.
 *
 *		Coded by Shigeki Yoshida (shige@csk.CO.JP)
 *			 and MURAMATSU Atsushi (amura@tomato.sakura.ne.jp)
 */
...
extern VOID utoe_in _PRO((int *c0, int *c1, int *c2));

#define	etou(a,b,c)	etou_in(&(a), &(b), c)
extern VOID etou_in _PRO((int *c0, int *c1, int c2));
